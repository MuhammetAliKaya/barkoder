        ...
        <div class="row">
            <div class="col-md-3">
                <div class="contact-info">
                    <img src="./assets/edit.png" alt="image" width="100" height="100" />
                    <h2>Ürün Düzenle</h2>
                    <h4>Ürün bilgilerini güncelleyin.</h4>
                </div>
            </div>
            

            <div class="col-md-9">
            <form method="POST" action="urunduzenle-do.php">
            
            <input type="hidden" value="<?php echo $_POST['urunid2']?>" name="urunid3">
                <div class="contact-form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-default" name="gonder">Ürünü Düzenle</button>
                        </div>
                    </div>
            </form>        
                </div>
